            ...
            <selectionEntry id="ff3c-3922-d0a7-b62f" name="1. Master of Timing" hidden="false" collective="false" import="true" type="upgrade">
              <profiles>
                <profile id="62dc-581b-0fc0-56f0" name="Master of Timing" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                  <characteristics>
                    <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">You can 重投 one 失败的 Reserve roll each turn.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <costs>
                ...
                <selectionEntry id="fb1a-ce7f-7432-a23b" name="46: Foresight" hidden="false" collective="false" import="true" type="upgrade">
                  ...
                  <profiles>
                    <profile id="1f69-1696-0676-0b09" name="46: Foresight" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                      <characteristics>
                        <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">一次性, if 这个模型 is 战场上, you can 重投 one 命中 roll, wound roll, 伤害 roll or saving throw.</characteristic>
                      </characteristics>
                    </profile>
                  </profiles>
                  <costs>
                ...
                <selectionEntry id="fdec-6130-c07f-340c" name="06: Inferno Round" hidden="false" collective="false" import="true" type="upgrade">
                  ...
                  <profiles>
                    <profile id="d1b4-cfe9-6852-26f5" name="06: Inferno Round" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                      <characteristics>
                        <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">Pick one of 这个模型’s ranged 武器. Add the following ability to that weapon: ‘单位 do not receive the benefit of cover to their saving throws 对抗 攻击 made with 这个武器.’</characteristic>
                      </characteristics>
                    </profile>
                  </profiles>
                  <costs>
                ...
                <selectionEntry id="f341-b493-710a-4058" name="08: Finely Balanced" hidden="false" collective="false" import="true" type="upgrade">
                  ...
                  <profiles>
                    <profile id="37ad-2ef0-0868-af26" name="08: Finely Balanced" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                      <characteristics>
                        <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">Pick one of 这个模型’s 肉搏武器. Add the following ability to that weapon: ‘每次 the bearer fights, it can make 1 additional attack with 这个武器.’</characteristic>
                      </characteristics>
                    </profile>
                  </profiles>
                  <costs>
                ...
                <selectionEntry id="119c-bce3-49b2-42b9" name="09: Shredder" hidden="false" collective="false" import="true" type="upgrade">
                  ...
                  <profiles>
                    <profile id="1ce8-bd94-7cf0-e20f" name="09: Shredder" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                      <characteristics>
                        <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">Pick one of 这个模型’s 肉搏武器. Add the following ability to that weapon: ‘可以重投失败的造伤骰 for 攻击 made with 这个武器.’</characteristic>
                      </characteristics>
                    </profile>
                  </profiles>
                  <costs>
                ...
                <selectionEntry id="2815-b0cf-9cd9-cda3" name="10: Brutal" hidden="false" collective="false" import="true" type="upgrade">
                  ...
                  <profiles>
                    <profile id="96c3-0639-a1a2-86e0" name="10: Brutal" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                      <characteristics>
                        <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">Pick one of 这个模型’s 肉搏武器. Improve that weapon’s S值 by 1 (e.g. User becomes +1, +1 becomes +2).</characteristic>
                      </characteristics>
                    </profile>
                  </profiles>
                  <costs>
                ...
                <selectionEntry id="1ff7-04bf-8369-9459" name="11: Razor-edged" hidden="false" collective="false" import="true" type="upgrade">
                  ...
                  <profiles>
                    <profile id="ae27-0269-204d-ceb0" name="11: Razor-edged" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                      <characteristics>
                        <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">Pick one of 这个模型’s 肉搏武器. Improve that weapon’s AP值 by 1 (e.g. AP -1 becomes AP -2).</characteristic>
                      </characteristics>
                    </profile>
                  </profiles>
                  <costs>
                ...
                <selectionEntry id="6f8b-aeb4-3dc6-15f6" name="12: Heirloom" hidden="false" collective="false" import="true" type="upgrade">
                  ...
                  <profiles>
                    <profile id="c8c0-671c-6174-969c" name="12: Heirloom" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                      <characteristics>
                        <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">Pick one of 这个模型’s 肉搏武器. Add the following ability to that weapon: ‘Each unmodified 命中 roll of 6 made for 攻击 with 这个武器 scores 2 命中 而不是 1’.</characteristic>
                      </characteristics>
                    </profile>
                  </profiles>
                  <costs>
            ...
            <selectionEntry id="21db-768e-a0c2-00fd" name="R3: Breachers" hidden="false" collective="false" import="true" type="upgrade">
              ...
              <profiles>
                <profile id="be38-1685-9783-10d4" name="R3: Breachers" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                  <characteristics>
                    <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">Add 1 to wound 骰 for 攻击 made by 模型 in 这个单位 if the target of those 攻击 is receiving the benefit of cover.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <costs>
            ...
            <selectionEntry id="997d-c097-a175-782f" name="R4: Juggernaut" hidden="false" collective="false" import="true" type="upgrade">
              ...
              <profiles>
                <profile id="6269-9ff1-822a-c610" name="R4: Juggernaut" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                  <characteristics>
                    <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">You can 重投 charge 骰 for 这个模型. </characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <costs>
            ...
            <selectionEntry id="738a-7c13-7eba-e433" name="R1: Skilled Driver" hidden="false" collective="false" import="true" type="upgrade">
              ...
              <profiles>
                <profile id="4af9-ed89-7d89-93c6" name="R1: Skilled Driver" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                  <characteristics>
                    <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">You can 重投 Advance 骰 for 这个单位. </characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <costs>
            ...
            <selectionEntry id="60dc-f09a-33ac-c917" name="R3: Storied 载具" hidden="false" collective="false" import="true" type="upgrade">
              ...
              <profiles>
                <profile id="2356-d59e-e2b3-6667" name="R3: Storied 载具" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
                  <characteristics>
                    <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">You can 重投 one 命中 roll or wound roll for 这个单位 in each of your 射击阶段. </characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <costs>
...
3) Tenacious Survivor: Roll a dice 每次 这个主将 失去1点W.  结果为6, the 主将 shrugs off the 伤害 and does not lose the wound.</description>
  ...
  <sharedProfiles>
    ...
    <profile id="d4b6-7a3a-aee5-d293" name="Ammo Store" publicationId="28ec-711c-pubN77581" page="110" hidden="false" typeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" typeName="能力">
      <characteristics>
        <characteristic name="描述" typeId="21befb24-fc85-4f52-a745-64b2e48f8228">A 单位 occupying this 建筑 re-骰 To 命中 骰 of a 1 when firing out of the 建筑&apos;s fire points. Note this does not apply to a 模型 manually firing an emplaced weapon.</characteristic>
      </characteristics>
    </profile>
